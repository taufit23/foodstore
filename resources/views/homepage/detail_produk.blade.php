...
<div class="col-12">
    <img src="{{ asset($produk->cover_produk) }}" class="product-image w-100" style="max-height: 410px"
        alt="Product Image">
</div>
<div class="col-sm-6">
    <div class="row">
        @foreach ($produk->image as $image)
        <div class="col-md-1">
            <div class="img img-thumbnail img-fluid" style="width: 1px"><img src="{{ asset($image->url) }}"
...
<div class="row mt-4">
    ...
    <div class="tab-content p-3" id="nav-tabContent">
        ...
        <div class="tab-pane fade" id="product-comments" role="tabpanel" aria-labelledby="product-comments-tab"> Vivamus
            rhoncus nisl sed venenatis luctus. Sed
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-3">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text"><small
                                    class="text-muted">{{ $produk->created_at->diffForHumans() }}</small></p>
                        </div>
                        <code>othet Image product</code>
                        <div class="row">
                ...
                <div class="row g-0">
                    <div class="col-md-12">
                        <h5>Produk kategori : {{ $produk->kategori->nama_kategori }}</h5>
                        <div class="row">
                            @foreach ($relate_produk as $prod)
                            <div class="col-md-3">
                                <div class="card text-white bg-dark">
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="{{ route('detail.produk', $prod->slug_produk) }}"
