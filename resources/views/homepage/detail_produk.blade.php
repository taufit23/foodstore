            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="col-12">
                            <img src="{{ asset($produk->cover_produk) }}" class="product-image w-100"
                                style="max-height: 410px" alt="Product Image">
                        </div>
                        <div class="col-sm-6">
                            <div class="row">
                                @foreach ($produk->image as $image)
                                <div class="col-md-1">
                                    <div class="img img-thumbnail img-fluid" style="width: 1px"><img
                                            src="{{ asset($image->url) }}" alt="Product Image"></div>
                                </div>
                                @endforeach
                            </div>
                        </div>
